...
<footer>
  <div class="container-fluid bg-dark">
    ...
    <p class="text-center text-light mb-0 pb-3 pt-3">Ce projet à été réalisé par Petot Sonny pour le projet 4 d'OpenClassroom </br> <a href="index.php?page=mention" class="text-warning">Mentions légales - </a><a href="index.php?page=admin" class="text-warning">Administration</a></p>
    </div>
  </div>
</footer>
