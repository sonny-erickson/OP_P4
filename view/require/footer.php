        ...
        <p class="text-center text-light mb-0 pb-3 pt-3">Ce projet à été réalisé par Petot Sonny pour le projet 4 d'OpenClassroom - <a href="view/mentions_legales.php">Mentions légales</a></p>
				</div>
			</div>
		</footer>
